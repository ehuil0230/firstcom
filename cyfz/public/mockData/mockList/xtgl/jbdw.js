...
const postData = function(req) {
    ...
    for (let i = 0; i < pageSize; i++) {
        let post = {
            ...
            proclamationName: "' "+Random.name()+"' "+"2019年度项目揭榜单位排名",
            createOrgName: Random.loggingDept(),
            createTime: Random.date(), // 随机生成时间
            stateName: Random.loggingStatus(),
        }
...
Mock.mock(`${domain}/jbdw`, /get|post/i, postData); // 定义请求链接，类型，还有返回数据
