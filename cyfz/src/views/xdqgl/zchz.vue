<template>
    <div class="rightMain">
        ...
        <!--工具栏-新建-->
        <createbar key="zchz" v-if="xjDialogVisible" :dialogData="dialogData" :taVisible="xjDialogVisible"
                   :checkdeData="checkedData" @refreshTable="refreshTable($event)"></createbar>
        ...
        methods: {
            ...
            toolbarClick(item, event) {
                ...
                if (item.title == '新建') {
                    ...
                    that.dialogData.fromType = '0009';
                    that.dialogData.spType = '010009';
                    this.xjDialogVisible = true;
                }
                if (item.title == '修改') {
                    /*修改初始化*/
