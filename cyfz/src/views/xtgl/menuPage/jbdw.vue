<template>
    <div class="rightMain">
        ...
        <!--工具栏-新建-->
        <createbar key="jbdw" v-if="xjDialogVisible" :dialogData="dialogData" :taVisible="xjDialogVisible"
        ...
        methods: {
            ...
            toolbarClick(item, event) {
                ...
                if (item.title == '新建') {
                    ...
                    that.dialogData.fromType = '0004'
                    that.dialogData.spType = '010004';
                }
                if (item.title == '修改') {
