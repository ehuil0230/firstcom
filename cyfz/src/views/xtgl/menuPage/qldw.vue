<template>
    <div class="rightMain">
        ...
        <!--工具栏-新建-->
        <createbar key="qldw" v-if="xjDialogVisible" :dialogData="dialogData" :taVisible="xjDialogVisible" @refreshTable="refreshTable($event)"></createbar>
    ...
    export default {
        ...
        data() {
            return {
                ...
                //调用组件传输返回页面数据
                getDataWay: {dataType: "url", data: this.$api.xtglApi.xtglTzggQuery,type: "post",param:{proclamationDm:'0005'}},
            }
        },
        methods: {
            //状态初始化
            ...
            toolbarClick(item,event) {
                ...
                if (item.title == '新建') {
                    ...
                    that.dialogData.fromType = '0005'
                    that.dialogData.spType = '010005';
                }
                if (item.title == '修改') {
